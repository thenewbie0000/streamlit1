...
loaded_model = pickle.load(open('C:/Program Files/model.sav', 'rb'))
...
def covid_prediction(input_data):
    ...
    if(prediction[0][0] >= 0.70):
        ...
        disp_msg = f"There is only {(prediction[0][0] * 100)}% chance that you have covid. You are less likely to be infected by covid, but you may stil get tested."
    return disp_msg
